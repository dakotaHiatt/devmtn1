...
var me = "Hello, my name is " + myName + " , and my favorite number is arbitrarily " + favNum;
...
var notHakeem;
if (myName !== "Hakeem Olajuwon") notHakeem = true;
...
/*
Or I believe that this would work also

canDrive = age >= 16;

I was less sure of that answer, so I stuck with my original answer.
 */

// #8 Create an if statement inside of the responseCreator function that sets the colorResponse variable value based off of a passed in value. The param value passed in will be added in the unit test. If the param value is 'green' set colorResponse variable to 'Green is okay'. If the param value is 'red' set response variable to 'I heart red'. Otherwise set the colorResponse variable to 'What is your favorite color?'. Make sure to return the colorResponse variable at the end once it has been properly set.

var colorResponse;

var responseCreator;
responseCreator = function (param) {
    if (param === "green") {
...
function greeter (name, number){
    return "Hi! I am " + name + " and I am " + number + " years old. How are you?";
}
